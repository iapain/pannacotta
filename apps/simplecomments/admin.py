...
from apps.simplecomments.models import Comment
from core.admin import AccountableAdmin

class CommentsAdmin(AccountableAdmin):
    ...
    def formfield_for_foreignkey(self, db_field, request, **kwargs):
        ...
        if db_field.name == "site":
            kwargs["queryset"] = Site.objects.filter(id=Account.objects.get(pk=request.account.pk).site_id)
