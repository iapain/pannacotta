...
from core.models import Accountable, Orderable, Displayable
from utils.urls import admin_url

class Page(Orderable, Displayable, Accountable):
...
class ContentPage(Page):
    ...
    template = models.ForeignKey("dbtemplates.Template", verbose_name=_("Template"), blank=True, null=True)
