...
class AccountableAdmin(admin.ModelAdmin):
    ...
    def save_form(self, request, form, change):
        ...
        if hasattr(obj, 'account') and obj.account_id is None:
            obj.account = request.account
        if hasattr(obj, 'user') and obj.user_id is None:
    ...
    def has_change_permission(self, request, obj=None):
        ...
        try:
            ...
            return False
        return opts.app_label + '.' + opts.get_change_permission() in perm
